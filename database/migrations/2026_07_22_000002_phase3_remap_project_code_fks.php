...
return new class extends Migration
{
    ...
    {
        // Step 1: Add temp columns to preserve old IDs for rollback safety
        ...
        // Step 2: Backup old values
        DB::statement('UPDATE timesheet_project_rows SET old_project_code_id_tmp = project_code_id');
        DB::statement('UPDATE ot_form_entries SET old_project_code_id_tmp = project_code_id');

        // Step 3: Remap to pm_projects.id
        $tsMapped = DB::statement('
        ...
        // Step 5: Drop old FK constraints and re-add to pm_projects
        Schema::table('timesheet_project_rows', function (Blueprint $table) {
