...
<div x-data="{ helpOpen: false }">
    ...
    <button @click="helpOpen = true"
            ...
            class="fixed bottom-6 right-6 z-50 w-12 h-12 hover:opacity-90 rounded-full shadow-lg flex items-center justify-center transition-all hover:scale-110 focus:outline-none focus:ring-2 focus:ring-blue-900 focus:ring-offset-2"
            title="Help">
                ...
                <div class="flex h-full flex-col bg-white shadow-xl">
                    ...
                    <div class="bg-blue-700 px-6 py-5">
                        <div class="flex items-center justify-between">
                            ...
                            <button @click="helpOpen = false" class="text-blue-200 hover:text-white transition-colors">
                                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
