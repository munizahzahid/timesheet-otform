            ...
            $listProps = [
                'projects' => $projects->map(function ($project) use ($currentUrl) {
                    return [
                        ...
                        'show_url' => route('admin.project.projects.show', $project),
                        'edit_url' => route('admin.project.projects.edit', $project) . '?' . http_build_query(['redirect' => $currentUrl]),
                    ];
                })->values()->toArray(),
                'success' => session('success'),
                'addUrl' => route('admin.project.projects.create'),
            ];
        @endphp
