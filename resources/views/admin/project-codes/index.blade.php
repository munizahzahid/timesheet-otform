<x-app-layout>
    ...
    <x-help-button title="Project Codes Help">
        <x-slot name="content">
            ...
            <p class="mb-3">View all project codes synced from Desknet. These are read-only and updated via the Desknet Sync.</p>
            <h4 class="font-semibold text-gray-900 mb-1">Features</h4>
            <ul class="list-disc pl-5 space-y-1">
                <li><strong>Search</strong> — Filter by code, name, client, or manager</li>
