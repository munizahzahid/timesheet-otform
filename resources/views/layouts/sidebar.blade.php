            ...
            <div x-show="hrOpen"
                ...
                <a href="{{ route('timesheets.index') }}"
                   class="flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm transition-all duration-200
                          {{ !$viewingOtherUser && request()->routeIs('timesheets.*') ? 'bg-blue-700 text-white font-medium shadow-md' : 'text-gray-400 hover:bg-blue-800 hover:text-white' }}">
                ...
                <a href="{{ route('ot-forms.index') }}"
                   class="flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm transition-all duration-200
                          {{ !$viewingOtherUser && request()->routeIs('ot-forms.*') ? 'bg-blue-700 text-white font-medium shadow-md' : 'text-gray-400 hover:bg-blue-800 hover:text-white' }}">
                    <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
